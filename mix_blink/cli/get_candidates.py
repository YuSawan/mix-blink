...
def main(data_args: DatasetArguments, model_args: ModelArguments, training_args: TrainingArguments) -> None:
    ...
    if model_args.negative == 'bm25':
        ...
        if 'test' in splits:
            ...
            splits['test'] = splits['test'].add_column("negatives", test_candidate_ids)
