...
def main(data_args: DatasetArguments, model_args: ModelArguments, training_args: TrainingArguments) -> None:
    ...
    if model_args.negative == 'dense':
        ...
        dense_retriever.dump(model.entity_encoder, os.path.join(training_args.output_dir, 'retriever_index.faiss'))
        ...
        assert training_args.output_dir is not None
        bm25_retriever.dump(os.path.join(training_args.output_dir, 'retriever_index.bm25'))
    else:
